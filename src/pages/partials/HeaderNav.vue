  ...
  <section class="header-wrapper">
    <h1 class="header-area">
      <a href="/" class="header-link">
        <img class="mark-markdown" src="@assets/images/logo.png" alt="PacDocs - PacDown" />
        <strong v-if="!isMobile" class="header-text">{{ titleText }}</strong>
      </a>
      <div class="button-group">
        <a href="https://docs.crybabyaq.love/blog/posts/welcome/" class="header-link">
          <span class="hint--bottom" aria-label="关于...">
            <icon class="header-icon" name="author" />
          </span>
        </a>
        <router-link to="/about-pacdown" class="header-link">
          <span class="hint--bottom" aria-label="关于 PacDown">
            <icon class="header-icon" name="document" />
          </span>
        </router-link>
        <a href="https://chatgpt.crybabyaq.love/" class="header-link">
        ...
        <a href="https://github.com/pacmandoh/" class="header-link">
