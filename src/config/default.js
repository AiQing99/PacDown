  ...
  series: [
    {
      ...
      center: ['50%', '60%'],
      data: [
        { value: 10440, name: 'R', itemStyle: { color: '#ef4136' } },
        { value: 4770, name: 'Python' },
        { value: 2430, name: 'JS/TS' },
        { value: 342, name: 'C++' },
        { value: 18, name: 'Java' }
      ],
      itemStyle: {
...
export default `# 欢迎使用 \`PacDocs\` 在线 Markdown 编辑器

它是一款基于 \`Vue\`、\`Vditor\`，为未来而构建的在线 Markdown 编辑器；轻量且强大：内置粘贴 HTML 自动转换为 Markdown，支持流程图、甘特图、时序图、任务列表，可导出携带样式的图片、PDF、微信公众号特制的 HTML 等等。

---

## 如何使用

**微注**：清空目前这份默认文档，即处于可使用态。 它另一大优点在于：编辑内容只会在您本地进行保存，不会上传您的数据至服务器，**绝不窥测用户个人隐私，可放心使用**；。
...
[Markdown](https://zh.wikipedia.org/wiki/Markdown) 是一种方便记忆、书写的纯文本标记语言，用户可以使用这些标记符号，以最小的输入代价，生成极富表现力的文档：譬如您正在阅读的这份文档。它使用简单的符号标记不同的标题，分割不同的段落，**粗体**、*斜体* 或者[超文本链接](https://vue-cli3.lovejade.cn/explore/)，更棒的是，它还可以：
...
| 作品名称        | 在线地址   |  上线日期  |
| :--------  | :-----  | :----:  |
| PacmanServer | [https://crybabyaq.love](https://crybabyaq.love) |2023-06-10|
| PacDocs | [https://docs.crybabyaq.love](https://docs.crybabyaq.love) |2023-10-24|
...
或是查看 [Markdown 基础指南](https://docs.crybabyaq.love/guide/typeset)。
...
最后由衷感谢[制作者](https://github.com/nicejade/) 以及 [vditor](https://b3log.org/vditor/) ❤️
